#!/usr/bin/env node
/**
 * Initialize X1SAFE V2 - Program 4377BZC8xDor2mGdWQK6ABXkhBpD6in3k9oLFp5iKmue
 */
...
const PROGRAM_ID = new PublicKey("4377BZC8xDor2mGdWQK6ABXkhBpD6in3k9oLFp5iKmue");
...
async function main() {
  ...
  fs.writeFileSync(".x1safe-mint-4377.json", JSON.stringify(Array.from(x1safeMint.secretKey)));
  ...
  try {
    ...
    fs.writeFileSync(".deployment-4377.json", JSON.stringify(info, null, 2));
    console.log("\n📝 Saved to .deployment-4377.json");
  } catch(e) {
