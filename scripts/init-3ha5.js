#!/usr/bin/env node
/**
 * Initialize X1SAFE V2 - Program 3ha5JkZi6bcwiinWo357pyFJcGH2UWi36AhGJn2LHJbD
 */
...
async function main() {
  ...
  fs.writeFileSync(".x1safe-mint-3ha5.json", JSON.stringify(Array.from(x1safeMint.secretKey)));
  ...
  try {
    ...
    fs.writeFileSync(".deployment-3ha5.json", JSON.stringify(info, null, 2));
  } catch(e) {
